...
class TextClassifier(PredictBase):
    def __init__(self, args):
        ...
        # 初始化模型
        self.cls_session = self.get_session(args.cls_model_dir, args.use_gpu, "cls")
        self.cls_input_name = self.get_input_name(self.cls_session)
        self.cls_output_name = self.get_output_name(self.cls_session)
